...
def get_images(path: typing.Union[str, Path], max_per_category: int = 100) -> list[Path]: 
    """
...
def get_images_alt(path: typing.Union[str, Path], max_per_category: int = 100) -> list[Path]: 
    """
...
def create_set(data_dir: typing.Union[str, Path], label: str) -> tf.data.Dataset:
    """
